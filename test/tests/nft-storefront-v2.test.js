...
const setup_nft_account_tx = fs.readFileSync(path.resolve(__dirname, "../mockTransactions/setup_nft_account.cdc"), {encoding:'utf8', flag:'r'});
const mint_nft_tx = fs.readFileSync(path.resolve(__dirname, "../mockTransactions/mint_nft.cdc"), {encoding:'utf8', flag:'r'});
...
describe("NFTStorefrontV2", ()=> {
  ...
  test("Cleanup expired listings", async() => {
    ...
    await shallPass(
      sendTransaction({
        name: "sell_item",
        args: [2, "50.50", "TopShot Platform 4", "10.50", currentTimestamp + 500,[]],
        signers: [seller_1]
      })
    ); 
